// M6 architecture profiler (ADR-0021).
//
...
// available from benchmark/boundary.dart; this harness supports M6.5
// performance qualification.
//
// Run from the repository root:
//   dart run benchmark/m6_architecture.dart
//
...
Future<void> main() async {
  ...
  final plainDir = await Directory.systemTemp.createTemp('m6-plain-');
  final encryptedDir = await Directory.systemTemp.createTemp('m6-encrypted-');
  try {

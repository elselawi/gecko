// relationship integration: index-wired FK lookups, the single
...
void main() {
  ...
  void runSuite(String label, Future<DatabaseImpl> Function(String tag) open) {
    group('relationship integration ($label)', () {
      test(
  ...
  runSuite('native file', (tag) async {
    final dir = await Directory.systemTemp.createTemp('gecko-relation-$tag-');
    addTearDown(() async {
      try {

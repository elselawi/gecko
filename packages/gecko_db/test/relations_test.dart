...
void main() {
  ...
  group('restrict names the offending dependent', () {
    test(
  ...
  group('application-controlled delete hook', () {
    test(
  ...
  group('cross-order batch integrity and orphan surfacing', () {
    test(
    ...
    test(
      ...
      () async {
        ...
        // The child now has no parent → orphaned per orphan semantics.

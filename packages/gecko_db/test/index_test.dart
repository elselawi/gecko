...
Future<DatabaseImpl> _open(String name, {List<String>? indexFields}) =>
    openNativeTestDatabase('index-$name');
...
void main() {
  group('secondary index: indexed queries avoid full scans', () {
    test(
      'equality query on indexed field uses the index (index + scan count)',
      () async {

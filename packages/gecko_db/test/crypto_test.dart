// physical page encryption and key management tests.
//
...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('gecko-crypto-');
  ...
  group('physical encryption', () {
    ...
    test('raw file scan never finds sentinel plaintext', () async {
      const sentinel = 'GECKO_PLAINTEXT_SENTINEL_XYZ_9876543210';
      final db = await openEncrypted(key: _keyA());

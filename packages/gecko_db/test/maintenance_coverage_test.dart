...
// conflict round-trips with a resolution, and native query coverage.
import 'dart:io';
...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('gecko-maintenance-cov-');

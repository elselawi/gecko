/// gecko_db — a local-first, reactive embedded database for Dart and Flutter.
///
/// **Progressive disclosure**: Tier 1 (box-style [`get`]/[`put`]/[`delete`]/
/// [`watch`]) is usable with zero knowledge of indexes, queries, relationships,
/// transactions, or sync. Each later tier is strictly additive to this public
/// API — it never forces Tier 1 users to learn Tier 3 concepts.
library;
...
export 'src/api/change.dart' show Change, ChangeSet, ChangeKind;
export 'src/api/conflict.dart'
    show
        ConflictApi,
        ConflictRequest,
        ...
        Resolution,
        ResolutionKind;
export 'src/api/sync_state.dart' show SyncState, SyncPhase;
export 'src/api/change_tracking.dart'
    show
        ChangeOrigin,
        ChangeRecord,
        SyncHookApi,
...
export 'src/api/schema.dart'
    show
        ...
        MigrationFailure,
        RecordRewriter;
export 'src/backend/byte_key.dart' show ByteKey;
export 'src/backend/raw_backend.dart'
    show
        RawBackend,
        RawSnapshot,
        RawOp,
...
export 'src/errors/native_error.dart' show mapNativeError;
export 'src/model/row_schema.dart'
    show RowSchema, FieldSpec, FieldPresence, FieldPatch;
export 'src/model/row_patch.dart' show applyPatch, applyDefaults, PatchResult;
export 'src/namespaces.dart'
    show geckoReservedPrefix, isReservedName, ensureUserTableName;
export 'src/native/native_resolver.dart'
    show
        NativeArtifact,
        NativeResolver,
        ResolverStorage,
...
export 'src/relation/relationship_manager.dart'
    show RelationshipManager, RowAccessors;
export 'src/reactive/change_bus.dart' show ChangeBus, ChangeBusOverflowError;
export 'src/wire/format_header.dart'
    show FormatHeader, geckoFormatVersion, geckoWireVersion;
export 'src/wire/compatibility.dart'
    show CompatibilityHandshake, geckoHandshakeVersion, geckoPackageVersion;
export 'src/wire/op.dart' show Op, OpKind, OpDecodeException;
export 'src/wire/wire_codec.dart'
    show RowValue, WireCodec, WireDecodeException, DefaultWireCodec;
export 'src/wire/sort_rules.dart'
    show sortBytesFor, SortRule, standardSortRules;
